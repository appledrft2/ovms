...
if ($lastPage != "1") {
  ...
  if ($pn != 1) {
    $previous = $pn - 1;
    $paginationDisplay .=  ' &nbsp;  <a class="" href="' . $_SERVER['PHP_SELF'] . '?pn=' . $previous . '"> Back</a> ';
  }
  ...
  if ($pn != $lastPage) {
    $nextPage = $pn + 1;
    $paginationDisplay .=  '&nbsp;  <a class="" href="' . $_SERVER['PHP_SELF'] . '?pn=' . $nextPage . '"> Next</a> ';
  }
}
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="alert alert-success alert-dismissible">
      ...
      <p><i class="icon fa fa-paw"></i> Good Day! Dear Customer, Don’t forget to add pet first before making an appointment. Thank you and God bless.</p>
    ...
    <div class="row">
      ...
      if (isset($_GET['result'])) {
        echo '<h3 class="text-center">Sorry, we could not find the product that your looking for. <a href="index.php"> Go Back</a></h3>';
      } else {
      ...
      ?>
        ...
        ?>
          ...
          <div class="col-md-12">
            <div style=" padding:6px; background-color:#FFF; border:#999 1px solid;">
              <h4 class="text-right"><?php echo $paginationDisplay; ?></h4>
            </div>
          </div>
