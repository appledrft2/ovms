...
$sql = "SELECT id,name,category,selling,image_path FROM tbl_product WHERE (name LIKE '%" . $_GET['keyword'] . "%' OR category LIKE '%" . $_GET['keyword'] . "%')  AND status = 'Available' ";
...
$sql2 = "SELECT id,name,category,selling,image_path FROM tbl_product WHERE (name LIKE '%" . $_GET['keyword'] . "%' OR category LIKE '%" . $_GET['keyword'] . "%') AND status = 'Available' ORDER BY id ASC $limit";
