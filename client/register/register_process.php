...
<?php 
  if(isset($_POST['btnRegister'])){
      ...
      $qry->bind_param("sssssssss",$_POST['firstname'],$_POST['middlename'],$_POST['lastname'],$_POST['username'],$_POST['gender'],$_POST['address'],$_POST['phone'],$hashed_password,$client_num);
