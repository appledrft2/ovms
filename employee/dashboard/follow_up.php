...
$sql = "SELECT id,firstname,middlename,lastname FROM tbl_client WHERE id = ?";
$qry = $connection->prepare($sql);
$qry->bind_param('i',$_GET['id']);
$qry->execute();
$qry->bind_result($id,$dbfn,$dbmn,$dbln);
$qry->store_result();
$qry->fetch ();
    ...
    <section class="content-header">
        <div class="row">
          <h1 class="col-md-6 text-left">
            <span class="text-left">Follow-Up Appointment</span>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="" class="form-control" readonly value="<?php echo $dbfn.' '.$dbmn.' '.$dbln; ?>" >
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button name="btnSave" class="btn btn-success" > Confirm Follow-Up</button>
              </form>
              </div>
            </div>
          </div>
...
if(isset($_POST['btnSave'])){
    $status = 'Approved';
    $type = 'Follow-Up';
    $sql = "INSERT INTO tbl_appointment(client_id,status,type,veterinarian_id,appointment_date,total) VALUES(?,?,?,?,?,?)";
    $qry = $connection->prepare($sql);
    $qry->bind_param("isssss",$_GET['id'],$status,$type,$_POST['veterinarian_id'],$_POST['appointment_date'],$_POST['total']);
    ...
    if($qry->execute()) {
      ...
      echo '<meta http-equiv="refresh" content="0; URL=index.php?status=followup">';
    }else{
