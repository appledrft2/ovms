          ...
          <div class="box">
            ...
            <div class="box-footer">
              <div class="pull-right">
                 <a id="printPageButton" href="<?php echo $baseurl; ?>employee/dashboard/crecords/history.php?id=<?php echo $_GET['cid']; ?>" class="btn btn-default" > Go Back</a>
...
if(isset($_POST['btnUpdate'])){
    ...
    echo '<meta http-equiv="refresh" content="0; URL=history.php?id='.$_GET['cid'].'&status=updated">';
